object FrmRelProdutos: TFrmRelProdutos
  ...
  object cdsProdutoSel: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspProdutos'
    Left = 168
    Top = 40
    object cdsProdutoSelCODIGO: TIntegerField
      DisplayLabel = 'Codigo'
      FieldName = 'CODIGO'
    end
    object cdsProdutoSelDESCRICAO: TStringField
  ...
  object dsProdutoSel: TDataSource
    DataSet = cdsProdutoSel
    Left = 168
    Top = 104
  end
  ...
  object ppReportProdutos: TppReport
    AutoStop = False
