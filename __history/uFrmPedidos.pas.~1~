...
type
  TFrmPedidos = class(TFrmPadrao)
    ...
    cdsParcelamentoDAT_VENCIMENTO: TSQLTimeStampField;
...
begin
  ...
  begin
    try
      try
        //Trans := DmPrincipal.SQLConn.BeginTransaction(TDBXIsolations.ReadCommitted);
      ...
      //DmPrincipal.SQLConn.CommitFreeAndNil(Trans);
      except
        //DmPrincipal.SQLConn.RollbackFreeAndNil(Trans);
      end;
    finally
      Crud.Free;
      CrudItem.Free;
